...
- Use SpecSync 5 with advisory coverage 0 and keep all four agent integrations installed.
- Treat `.trust.toml` as policy authority and preserve landing-page UI, content, links, and publication behavior.
